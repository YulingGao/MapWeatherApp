...
public class UserCityDB extends SQLiteOpenHelper {
     ...
     * @param cityName cityname carried over
     * this method is to insert the city to the specific user in db
     */
     ...
     * @param username username carried over
     * @param cityName cityname carried over
     * this method is to check if city of the specific user exist in db
     */
     ...
     * @param username username carried over
     * @param cityName cityname carried over
     * this method is to remove the city to the specific user in db
     */
    ...
    /**
     * @param username username carried over
     * this method is to get the whole city list of the specific user from db
     */
