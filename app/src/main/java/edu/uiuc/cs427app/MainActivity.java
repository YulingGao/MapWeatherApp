...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     * override item selection to handle logout action
     */
    @Override
    ...
    /**
     * edit darktheme, initialize the main page
     */
    @Override
    ...
    /**
     * initialize button add location and remove location functionality
     */
    @Override
